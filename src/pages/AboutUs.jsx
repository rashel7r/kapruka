      ...
      <div className="flex-1 mt-[108px]">
        <div className="w-full flex justify-center">
          <img 
            src={saleBanner} 
            alt="Sale Banner" 
            className="w-full h-[150px] sm:h-[200px] md:h-[410px] object-cover"
          />
        </div>

        <section className="container px-4 md:px-6 py-4 md:py-10 mx-auto text-black mt-8 md:mt-28 bg-gradient-to-r from-[#5CAF90] via-[#7DCFB0] to-[#5CAF90] xl:px-20 xl:w-full">
          <Slide direction="up" triggerOnce>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 text-center xl:gap-8 xl:px-40">
              <div className="p-2">
                <p className="text-2xl sm:text-3xl md:text-[60px] text-[#1D372E] font-bold">
                  <CountUp end={15} duration={2} />+
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm">Years of Experience</p>
              </div>
              <div className="p-2">
                <p className="text-2xl sm:text-3xl md:text-[60px] text-[#1D372E] font-bold">
                  <CountUp end={99} duration={2} />%
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm">Satisfied Clients</p>
              </div>
              <div className="p-2">
                <p className="text-2xl sm:text-3xl md:text-[60px] text-[#1D372E] font-bold">
                  <CountUp end={98} duration={2} />+
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm">Expert Team Member</p>
              </div>
              <div className="p-2">
                <p className="text-2xl sm:text-3xl md:text-[60px] text-[#1D372E] font-bold">
                  7k+
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm">Projects Completed</p>
              </div>
            </div>
          </Slide>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 relative">
              <div className="text-center">
                <div className="mb-3 md:mb-6 w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 mx-auto">
                  <img 
                    src={visionImage}
                    alt="Vision"
                    className="w-full h-full object-contain border-2 border-[#5CAF90] p-3 md:p-4 rounded-lg"
                  />
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 md:mb-4">Our vision</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-4">Our Mission</h3>
              ...
              <div className="text-center">
                <div className="mb-4 md:mb-6 w-32 h-32 md:w-48 md:h-48 mx-auto">
                  <img 
                    src={valueImage}
                    alt="Values"
                    className="w-full h-full object-contain border-2 border-[#5CAF90] p-4 rounded-lg"
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-4">Our value</h3>
                <p className="text-gray-600 text-xs md:text-sm">
